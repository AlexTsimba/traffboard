...
export class CohortDataService {
  ...
  private convertToAppliedFilters(filters: Record<string, unknown>): AppliedFilter[] {
  ...
  private generateQueryHash(filters: Record<string, unknown>, metric: string, mode: string): string {
