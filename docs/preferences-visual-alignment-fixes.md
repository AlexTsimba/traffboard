...
<Card className="h-fit">
  <CardHeader className="pb-2">
    ...
    <CardDescription className="text-sm">Customize sidebar and content layout.</CardDescription>
  </CardHeader>
  <CardContent className="px-6 pt-0 pb-4">
    <LayoutSelector />
  </CardContent>
...
<Card>
  ...
  <CardContent className="space-y-2 px-6 pt-0 pb-4">{/* content */}</CardContent>
</Card>
```
